...
#SOUND_FX VARIABLES
var sfx_hurt : AudioStream = load("res://Sounds/SFX/SOTN - blade_wounded.wav")
var sfx_attack : AudioStream = load("res://Sounds/SFX/SOTN - blade_attacks.wav")
var sfx_die : AudioStream = load("res://Sounds/SFX/SOTN - skelerang_dies.wav")
...
func _collision_handler():
	...
	if (anim == "attack" and anim_frame == 6):
